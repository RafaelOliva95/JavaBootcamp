...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        // nextInt() example
        // * Skips the white space and picks up the next Integer
        ...
        System.out.print("\nEnter a greeting: ");
        // *Pick up a line of data 
        //! It might skip the next line because it will place the empty space of your previous answers
        scanner.nextLine(); // * To clean the buffer place an scanner.nextLine(); 
        String greeting = scanner.nextLine();

        System.out.println("Greeting: " + greeting);

        // nextDouble() example
        // * Skips the white space and picks up the next Double
        ...
        // nextLong() example
        // * Skips the white space and picks up the next Long
        ...
        // next() example
        // * Skips the white space and picks up the next String
        System.out.print("\nEnter three colors: ");
        ...
        String colorCombination = scanner.next(); // *Seems that also works for next instead of using nextLine
        System.out.println("Favorite color combination: " + colorCombination);

        scanner.close();
        //! nextLine() gets skipped when placed after nextInt(), nextDouble(), nextLong(), next()
        // *Solution is use scanner.nextLine();
