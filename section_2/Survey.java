/* 03/27/2025
 * author: Rafael Oliva
 * Create an Instance of Scanner to read data from user
 * Example using daily expenses data
 */
...
public class Survey {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in); //Initialize Scanner interface
        int counter = 0;
        ...
        scanner.close(); // !Always close the scanner if not you will get a resource leak
